...
<div id="settings-page" class="row-fluid">
    <ul class="nav nav-tabs">
        <li class="current-tab tab"><a><?php echo $this->lang->line('current_report'); ?></a></li>
        <li class="historic-tab tab"><a><?php echo $this->lang->line('historic_report'); ?></a></li>
    </ul>
